...
import makkahstyle from '@/app/makimgcomponents/makweather.module.css';
...
export default function Weather() {
    ...
    const url =`https://api.openweathermap.org/data/2.5/weather?q=Makkah al Mukarramah&appid=47bd37fa2a68e897e27df37a9a6fa4b3`
   useEffect(() => {
    setLoading(true);
